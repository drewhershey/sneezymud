...
class TPerson : public TBeing {
  ...
  public:
    ...
    void setBaseAge(unsigned short num) { base_age = num; }
    virtual unsigned short getBaseAge() const { return base_age; }
    ...
    virtual unsigned int getTimer() const { return timer; }
    virtual void setTimer(unsigned int num) { timer = num; }
    virtual void addToTimer(unsigned int num) { timer += num; }
    ...
    void doMap(const sstring&);
    void doMapList(const sstring&) const;
    void doMapAdd(const sstring&);
    void doMapRm(const sstring&);
    void doMapGo(const sstring&);
    void doMapRecalc(int startZ) const;
    void drawMap(const int size) const;
    void doRemember(bool print, const sstring&);
    void doRememberPlayer(bool print, const sstring&);
    void doRetrieve(bool print, const sstring&);
