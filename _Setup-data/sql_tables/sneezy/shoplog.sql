...
CREATE TABLE `shoplog` (
  ...
  PRIMARY KEY (`id`),
  KEY `shoplog_logtime` (`logtime`),
  KEY `idx_shoplog_shop_name` (`shop_nr`,`name`),
  CONSTRAINT `fk_shoplog_shop_nr` FOREIGN KEY (`shop_nr`) REFERENCES `shop` (`shop_nr`) ON DELETE CASCADE
