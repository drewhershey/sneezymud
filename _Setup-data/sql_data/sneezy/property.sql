...
CREATE TABLE `property` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_property_owner` (`owner`),
  CONSTRAINT `fk_property_owner` FOREIGN KEY (`owner`) REFERENCES `player` (`id`) ON DELETE SET NULL
...
(1,'NW Market Square Apartment',NULL,562,580),
